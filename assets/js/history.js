...
$(function() {
  ...
  $(function() {
      ...
      function switchHistoryStep(step, onCompleteCallback) {
          ...
          if (step === 0) { // 2010 -> 2000
              tl.to([title2, swiperContainer2], { opacity: 0, pointerEvents: 'none', duration: 0.4 });
              tl.to([title1, swiperContainer1], { opacity: 1, pointerEvents: 'auto', duration: 0.4 }, 0);
          } else { // 2000 -> 2010
              tl.to([title1, swiperContainer1], { opacity: 0, pointerEvents: 'none', duration: 0.4 });
              tl.to([title2, swiperContainer2], { opacity: 1, pointerEvents: 'auto', duration: 0.4 }, 0);
          }
      }
  });